    ...
    return <section className={styles.container}>
        <div className={styles.content}>
            ...
            <p className={styles.presentation}>
                ...
                Outre mes recherches personnelles, je me suis orienté vers un Bachelor Universitaire de Technologie (BUT) pour mettre
                un pied à l'étrier dans ce vaste monde.<br /> <br /> Je suis aujourd'hui en 3ème année, en option Ingénierie Logicielle. <br />
